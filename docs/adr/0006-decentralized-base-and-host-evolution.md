...
Omapack needs useful package sharing before anyone operates a registry, and
...
native Omarchy dependency installer can consume Omapack resolution and lock
data without requiring committed vendor directories.

## Consequences

Omapack works without centralized infrastructure today. Popularity can improve
