...
Git commit IDs identify repository history, not the package envelope Omapack
...
Omapack can prove that installed source matches the reviewed package envelope
